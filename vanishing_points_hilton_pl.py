...
if __name__ == "__main__":
    ...
    image = cv2.imread('hilton_pl.jpg')
    image = cv2.copyMakeBorder(image, 100, 10000, 10000, 10000, cv2.BORDER_CONSTANT)

    image = plotter(image, 'hilton_pl_horizontal.npy', (0, 255, 0))    
    image = plotter(image, 'hilton_pl_diagonal.npy', (0, 255, 0))  
    image = plotter(image, 'hilton_pl_vertical.npy', (0, 255, 0))    
